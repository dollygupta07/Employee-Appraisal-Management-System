...
export class AddEmployeeComponent implements OnInit {
  ...
  SectioinArray: any = ['Assistant', 'Associate', 'Accountant', 'Analyst', 'Team Leader','Advisor','Business Analyst'];
  Evaluationtype:any=['probation(90 days)','Ending probation(150 days)','Annual Review'];
  Rating=[
    {name:"Punctuality/Discipline",rate:0},
    {name:"Team-work",rate:0},
    {name:"Communication",rate:0},
    {name:"Quality of work",rate:0},
    {name:"Presonal Development",rate:0},
    {name:"Leadership",rate:0},
    {name:"Initiative",rate:0},
    {name:"Overall rating",rate:0},
